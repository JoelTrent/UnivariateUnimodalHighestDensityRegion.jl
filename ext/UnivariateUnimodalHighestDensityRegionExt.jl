...
"""
function _univariate_unimodal_HDR(d::DiscreteUnivariateDistribution, 
        region::Real, 
        solve_alg, 
        solve_kwargs::NamedTuple)
...
"""
function _univariate_unimodal_HDR(d::ContinuousUnivariateDistribution, 
        region::Real, 
        solve_alg, 
        solve_kwargs::NamedTuple)
...
function UnivariateUnimodalHighestDensityRegion.univariate_unimodal_HDR(d::UnivariateDistribution,
    ...
    return _univariate_unimodal_HDR(d, region, solve_alg, solve_kwargs)
end
